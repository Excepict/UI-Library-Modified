...
if v:IsA("ScreenGui") and string.match(v.Name,"Excepict123") then
v:Destroy()
end
end
...
UILibrary.Name = tostring(math.random(100000,700000).."_Excepict123"
if(syn) then 
...
local UEEE = game:GetService("UserInputService")
local coeeoldown = false
UEEE.InputBegan:Connect(function(key,isyy)
if isyy then return; end;
if key.KeyCode == Enum.KeyCode.LeftControl
if coeeoldown then return; end;
coeeoldown = true
